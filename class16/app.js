...
// var par="hello fahad pagal";
// document.getElementById("para").innerText=par;
// }


// function read(){

// var text='<h1>fahad</h1>;'
...
// var ele="<h1>hello</h1>";
// var f=document.getElementById("para").innerHTML=ele;
// console.log(f);

// function abc(){
// var ele=document.getElementById("para").className="pgl";
...
// function big(){
// var imgg=document.getElementById('car');
// imgg.className+=' pgl';
...
//  image.style.fontSize='5em';

// }


var ele=document.getElementsByTagName("p");
ele[0].style.fontSize='5em';
